...
cong :: proxy f -> SRefl (refl :: c :~: b) -> SRefl (Cong f refl :: f c :~: f b)
cong _ SRefl = SRefl
...
plusAssoc _ _ _ = unsafeCoerce SRefl
...
plusRightIdentity _ = unsafeCoerce SRefl
...
plusRightSucc _ _ = unsafeCoerce SRefl
...
plusComm _ _ = unsafeCoerce SRefl
